...
#include "../Includes/core_cm4.h"                               /*!< Cortex-M4 processor and core peripherals                              */
...
{ /*!< WATCHDOG0 Structure                                                   */
    ...
    __I uint32_t RESERVED0[256];__IO uint32_t TEST; /*!< Watchdog Test                                                         */
    __I uint32_t RESERVED1[505];__IO uint32_t LOCK; /*!< Watchdog Lock                                                         */
} WATCHDOG0_Type;
...
typedef struct
{ /*!< GPIOA Structure                                                       */
    __I uint32_t RESERVED0[255];__IO uint32_t DATA; /*!< GPIO Data                                                             */
    ...
    __I uint32_t RESERVED1[55];__IO uint32_t DR2R; /*!< GPIO 2-mA Drive Select                                                */
...
{ /*!< SSI0 Structure                                                        */
    ...
    __I uint32_t RESERVED0[1000];__IO uint32_t CC; /*!< SSI Clock Configuration                                               */
} SSI0_Type;
...
{ /*!< UART0 Structure                                                       */
    ...
    };__I uint32_t RESERVED0[4];__IO uint32_t FR; /*!< UART Flag                                                             */
    __I uint32_t RESERVED1;__IO uint32_t ILPR; /*!< UART IrDA Low-Power Register                                          */
    ...
    __I uint32_t RESERVED2[22];__IO uint32_t _9BITADDR; /*!< UART 9-Bit Self Address                                               */
    __IO uint32_t _9BITAMASK; /*!< UART 9-Bit Self Address Mask                                          */
    __I uint32_t RESERVED3[965];__IO uint32_t PP; /*!< UART Peripheral Properties                                            */
    __I uint32_t RESERVED4;__IO uint32_t CC; /*!< UART Clock Configuration                                              */
} UART0_Type;
...
{ /*!< I2C0 Structure                                                        */
    ...
    __I uint32_t RESERVED0;__IO uint32_t MBMON; /*!< I2C Master Bus Monitor                                                */
    __I uint32_t RESERVED1[2];__IO uint32_t MCR2; /*!< I2C Master Configuration 2                                            */
    __I uint32_t RESERVED2[497];__IO uint32_t SOAR; /*!< I2C Slave Own Address                                                 */
    ...
    __I uint32_t RESERVED3[487];__IO uint32_t PP; /*!< I2C Peripheral Properties                                             */
...
{ /*!< PWM0 Structure                                                        */
    ...
    __I uint32_t RESERVED0[5];__IO uint32_t _0_CTL; /*!< PWM0 Control                                                          */
    ...
    __I uint32_t RESERVED1[432];__IO uint32_t _0_FLTSEN; /*!< PWM0 Fault Pin Logic Sense                                            */
    __I uint32_t _0_FLTSTAT0; /*!< PWM0 Fault Status 0                                                   */
    __I uint32_t _0_FLTSTAT1; /*!< PWM0 Fault Status 1                                                   */
    __I uint32_t RESERVED2[29];__IO uint32_t _1_FLTSEN; /*!< PWM1 Fault Pin Logic Sense                                            */
    __I uint32_t _1_FLTSTAT0; /*!< PWM1 Fault Status 0                                                   */
    __I uint32_t _1_FLTSTAT1; /*!< PWM1 Fault Status 1                                                   */
    __I uint32_t RESERVED3[30];__I uint32_t _2_FLTSTAT0; /*!< PWM2 Fault Status 0                                                   */
    __I uint32_t _2_FLTSTAT1; /*!< PWM2 Fault Status 1                                                   */
    __I uint32_t RESERVED4[30];__I uint32_t _3_FLTSTAT0; /*!< PWM3 Fault Status 0                                                   */
    __I uint32_t _3_FLTSTAT1; /*!< PWM3 Fault Status 1                                                   */
    __I uint32_t RESERVED5[397];__IO uint32_t PP; /*!< PWM Peripheral Properties                                             */
} PWM0_Type;
...
{ /*!< TIMER0 Structure                                                      */
    ...
    __I uint32_t RESERVED0;__IO uint32_t IMR; /*!< GPTM Interrupt Mask                                                   */
    ...
    __I uint32_t RESERVED1[981];__IO uint32_t PP; /*!< GPTM Peripheral Properties                                            */
} TIMER0_Type;
...
{ /*!< ADC0 Structure                                                        */
    ...
    __I uint32_t RESERVED0;__IO uint32_t SAC; /*!< ADC Sample Averaging Control                                          */
    __IO uint32_t DCISC; /*!< ADC Digital Comparator Interrupt Status and Clear                     */
    __IO uint32_t CTL; /*!< ADC Control                                                           */
    __I uint32_t RESERVED1;__IO uint32_t SSMUX0; /*!< ADC Sample Sequence Input Multiplexer Select 0                        */
    ...
    __I uint32_t RESERVED2[2];__IO uint32_t SSMUX1; /*!< ADC Sample Sequence Input Multiplexer Select 1                        */
    ...
    __I uint32_t RESERVED3[2];__IO uint32_t SSMUX2; /*!< ADC Sample Sequence Input Multiplexer Select 2                        */
    ...
    __I uint32_t RESERVED4[2];__IO uint32_t SSMUX3; /*!< ADC Sample Sequence Input Multiplexer Select 3                        */
    ...
    __I uint32_t RESERVED5[786];__O uint32_t DCRIC; /*!< ADC Digital Comparator Reset Initial Conditions                       */
    __I uint32_t RESERVED6[63];__IO uint32_t DCCTL0; /*!< ADC Digital Comparator Control 0                                      */
    ...
    __I uint32_t RESERVED7[8];__IO uint32_t DCCMP0; /*!< ADC Digital Comparator Range 0                                        */
    ...
    __I uint32_t RESERVED8[88];__IO uint32_t PP; /*!< ADC Peripheral Properties                                             */
...
{ /*!< COMP Structure                                                        */
    ...
    __I uint32_t RESERVED0;__IO uint32_t ACREFCTL; /*!< Analog Comparator Reference Voltage Control                           */
    __I uint32_t RESERVED1[3];__IO uint32_t ACSTAT0; /*!< Analog Comparator Status 0                                            */
    __IO uint32_t ACCTL0; /*!< Analog Comparator Control 0                                           */
    __I uint32_t RESERVED2[6];__IO uint32_t ACSTAT1; /*!< Analog Comparator Status 1                                            */
    __IO uint32_t ACCTL1; /*!< Analog Comparator Control 1                                           */
    __I uint32_t RESERVED3[990];__IO uint32_t PP; /*!< Analog Comparator Peripheral Properties                               */
} COMP_Type;
...
{ /*!< CAN0 Structure                                                        */
    ...
    __I uint32_t RESERVED0;__IO uint32_t IF1CRQ; /*!< CAN IF1 Command Request                                               */
    ...
    __I uint32_t RESERVED1[13];__IO uint32_t IF2CRQ; /*!< CAN IF2 Command Request                                               */
    ...
    __I uint32_t RESERVED2[21];__IO uint32_t TXRQ1; /*!< CAN Transmission Request 1                                            */
    __IO uint32_t TXRQ2; /*!< CAN Transmission Request 2                                            */
    __I uint32_t RESERVED3[6];__IO uint32_t NWDA1; /*!< CAN New Data 1                                                        */
    __IO uint32_t NWDA2; /*!< CAN New Data 2                                                        */
    __I uint32_t RESERVED4[6];__IO uint32_t MSG1INT; /*!< CAN Message 1 Interrupt Pending                                       */
    __IO uint32_t MSG2INT; /*!< CAN Message 2 Interrupt Pending                                       */
    __I uint32_t RESERVED5[6];__IO uint32_t MSG1VAL; /*!< CAN Message 1 Valid                                                   */
...
{ /*!< USB0 Structure                                                        */
    ...
    __I uint32_t RESERVED0[4];__IO uint32_t FIFO0; /*!< USB FIFO Endpoint 0                                                   */
    ...
    __I uint32_t RESERVED1[8];__IO uint8_t DEVCTL; /*!< USB Device Control                                                    */
    __I uint8_t RESERVED2[1];__IO uint8_t TXFIFOSZ; /*!< USB Transmit Dynamic FIFO Sizing                                      */
    ...
    __I uint32_t RESERVED3[4];__I uint16_t RESERVED4;__IO uint8_t CONTIM; /*!< USB Connect Timing                                                    */
    __IO uint8_t VPLEN; /*!< USB OTG VBUS Pulse Timing                                             */
    __I uint8_t RESERVED5[1];__IO uint8_t FSEOF; /*!< USB Full-Speed Last Transaction to End of Frame Timing                */
    __IO uint8_t LSEOF; /*!< USB Low-Speed Last Transaction to End of Frame Timing                 */
    __I uint8_t RESERVED6[1];__IO uint8_t TXFUNCADDR0; /*!< USB Transmit Functional Address Endpoint 0                            */
    __I uint8_t RESERVED7[1];__IO uint8_t TXHUBADDR0; /*!< USB Transmit Hub Address Endpoint 0                                   */
    __IO uint8_t TXHUBPORT0; /*!< USB Transmit Hub Port Endpoint 0                                      */
    __I uint32_t RESERVED8;__IO uint8_t TXFUNCADDR1; /*!< USB Transmit Functional Address Endpoint 1                            */
    __I uint8_t RESERVED9[1];__IO uint8_t TXHUBADDR1; /*!< USB Transmit Hub Address Endpoint 1                                   */
    ...
    __I uint8_t RESERVED10[1];__IO uint8_t RXHUBADDR1; /*!< USB Receive Hub Address Endpoint 1                                    */
    ...
    __I uint8_t RESERVED11[1];__IO uint8_t TXHUBADDR2; /*!< USB Transmit Hub Address Endpoint 2                                   */
    ...
    __I uint8_t RESERVED12[1];__IO uint8_t RXHUBADDR2; /*!< USB Receive Hub Address Endpoint 2                                    */
    ...
    __I uint8_t RESERVED13[1];__IO uint8_t TXHUBADDR3; /*!< USB Transmit Hub Address Endpoint 3                                   */
    ...
    __I uint8_t RESERVED14[1];__IO uint8_t RXHUBADDR3; /*!< USB Receive Hub Address Endpoint 3                                    */
    ...
    __I uint8_t RESERVED15[1];__IO uint8_t TXHUBADDR4; /*!< USB Transmit Hub Address Endpoint 4                                   */
    ...
    __I uint8_t RESERVED16[1];__IO uint8_t RXHUBADDR4; /*!< USB Receive Hub Address Endpoint 4                                    */
    ...
    __I uint8_t RESERVED17[1];__IO uint8_t TXHUBADDR5; /*!< USB Transmit Hub Address Endpoint 5                                   */
    ...
    __I uint8_t RESERVED18[1];__IO uint8_t RXHUBADDR5; /*!< USB Receive Hub Address Endpoint 5                                    */
    ...
    __I uint8_t RESERVED19[1];__IO uint8_t TXHUBADDR6; /*!< USB Transmit Hub Address Endpoint 6                                   */
    ...
    __I uint8_t RESERVED20[1];__IO uint8_t RXHUBADDR6; /*!< USB Receive Hub Address Endpoint 6                                    */
    ...
    __I uint8_t RESERVED21[1];__IO uint8_t TXHUBADDR7; /*!< USB Transmit Hub Address Endpoint 7                                   */
    ...
    __I uint8_t RESERVED22[1];__IO uint8_t RXHUBADDR7; /*!< USB Receive Hub Address Endpoint 7                                    */
    __IO uint8_t RXHUBPORT7; /*!< USB Receive Hub Port Endpoint 7                                       */
    __I uint32_t RESERVED23[16];__I uint16_t RESERVED24;
    ...
    __I uint16_t RESERVED25[3];__IO uint8_t COUNT0; /*!< USB Receive Byte Count Endpoint 0                                     */
    __I uint8_t RESERVED26[1];__IO uint8_t TYPE0; /*!< USB Type Endpoint 0                                                   */
    __IO uint8_t NAKLMT; /*!< USB NAK Limit                                                         */
    __I uint32_t RESERVED27;__IO uint16_t TXMAXP1; /*!< USB Maximum Transmit Data Endpoint 1                                  */
    ...
    };__I uint16_t RESERVED28;__IO uint16_t TXMAXP2; /*!< USB Maximum Transmit Data Endpoint 2                                  */
    ...
    };__I uint16_t RESERVED29;__IO uint16_t TXMAXP3; /*!< USB Maximum Transmit Data Endpoint 3                                  */
    ...
    };__I uint16_t RESERVED30;__IO uint16_t TXMAXP4; /*!< USB Maximum Transmit Data Endpoint 4                                  */
    ...
    };__I uint16_t RESERVED31;__IO uint16_t TXMAXP5; /*!< USB Maximum Transmit Data Endpoint 5                                  */
    ...
    };__I uint16_t RESERVED32;__IO uint16_t TXMAXP6; /*!< USB Maximum Transmit Data Endpoint 6                                  */
    ...
    };__I uint16_t RESERVED33;__IO uint16_t TXMAXP7; /*!< USB Maximum Transmit Data Endpoint 7                                  */
    ...
    };__I uint16_t RESERVED34[195];__IO uint16_t RQPKTCOUNT1; /*!< USB Request Packet Count in Block Transfer Endpoint 1                 */
    __I uint16_t RESERVED35;__IO uint16_t RQPKTCOUNT2; /*!< USB Request Packet Count in Block Transfer Endpoint 2                 */
    __I uint16_t RESERVED36;__IO uint16_t RQPKTCOUNT3; /*!< USB Request Packet Count in Block Transfer Endpoint 3                 */
    __I uint16_t RESERVED37;__IO uint16_t RQPKTCOUNT4; /*!< USB Request Packet Count in Block Transfer Endpoint 4                 */
    __I uint16_t RESERVED38;__IO uint16_t RQPKTCOUNT5; /*!< USB Request Packet Count in Block Transfer Endpoint 5                 */
    __I uint16_t RESERVED39;__IO uint16_t RQPKTCOUNT6; /*!< USB Request Packet Count in Block Transfer Endpoint 6                 */
    __I uint16_t RESERVED40;__IO uint16_t RQPKTCOUNT7; /*!< USB Request Packet Count in Block Transfer Endpoint 7                 */
    __I uint16_t RESERVED41[17];__IO uint16_t RXDPKTBUFDIS; /*!< USB Receive Double Packet Buffer Disable                              */
    __IO uint16_t TXDPKTBUFDIS; /*!< USB Transmit Double Packet Buffer Disable                             */
    __I uint32_t RESERVED42[47];__IO uint32_t EPC; /*!< USB External Power Control                                            */
    ...
    __I uint32_t RESERVED43[4];__IO uint32_t VDC; /*!< USB VBUS Droop Control                                                */
    ...
    __I uint32_t RESERVED44;__IO uint32_t IDVRIS; /*!< USB ID Valid Detect Raw Interrupt Status                              */
    ...
    __I uint32_t RESERVED45[731];__IO uint32_t PP; /*!< USB Peripheral Properties                                             */
} USB0_Type;
...
{ /*!< EEPROM Structure                                                      */
    ...
    __I uint32_t RESERVED0;__IO uint32_t EERDWR; /*!< EEPROM Read-Write                                                     */
    ...
    __I uint32_t RESERVED1[3];__IO uint32_t EEPROT; /*!< EEPROM Protection                                                     */
    ...
    __I uint32_t RESERVED2[3];__IO uint32_t EEHIDE; /*!< EEPROM Block Hide                                                     */
    __I uint32_t RESERVED3[11];__IO uint32_t EEDBGME; /*!< EEPROM Debug Mass Erase                                               */
    __I uint32_t RESERVED4[975];__IO uint32_t PP; /*!< EEPROM Peripheral Properties                                          */
} EEPROM_Type;
...
{ /*!< HIB Structure                                                         */
    ...
    __I uint32_t RESERVED0;__IO uint32_t RTCLD; /*!< Hibernation RTC Load                                                  */
    ...
    __I uint32_t RESERVED1;__IO uint32_t DATA; /*!< Hibernation Data                                                      */
} HIB_Type;
...
{ /*!< FLASH_CTRL Structure                                                  */
    ...
    __I uint32_t RESERVED0[2];__IO uint32_t FMC2; /*!< Flash Memory Control 2                                                */
    __I uint32_t RESERVED1[3];__IO uint32_t FWBVAL; /*!< Flash Write Buffer Valid                                              */
    __I uint32_t RESERVED2[51];__IO uint32_t FWBN; /*!< Flash Write Buffer n                                                  */
    __I uint32_t RESERVED3[943];__IO uint32_t FSIZE; /*!< Flash Size                                                            */
    ...
    };__I uint32_t RESERVED5[72];__IO uint32_t RMCTL; /*!< ROM Control                                                           */
    __I uint32_t RESERVED6[55];__IO uint32_t BOOTCFG; /*!< Boot Configuration                                                    */
    __I uint32_t RESERVED7[3];__IO uint32_t USERREG0; /*!< User Register 0                                                       */
    __IO uint32_t USERREG1; /*!< User Register 1                                                       */
    __IO uint32_t USERREG2; /*!< User Register 2                                                       */
    __IO uint32_t USERREG3; /*!< User Register 3                                                       */
    __I uint32_t RESERVED8[4];__IO uint32_t FMPRE0; /*!< Flash Memory Protection Read Enable 0                                 */
    ...
    __I uint32_t RESERVED9[124];__IO uint32_t FMPPE0; /*!< Flash Memory Protection Program Enable 0                              */
...
{ /*!< SYSCTL Structure                                                      */
    ...
    __I uint32_t RESERVED0;__IO uint32_t DC1; /*!< Device Capabilities 1                                                 */
    ...
    __I uint32_t RESERVED1[3];__IO uint32_t SRCR0; /*!< Software Reset Control 0                                              */
    __IO uint32_t SRCR1; /*!< Software Reset Control 1                                              */
    __IO uint32_t SRCR2; /*!< Software Reset Control 2                                              */
    __I uint32_t RESERVED2;__IO uint32_t RIS; /*!< Raw Interrupt Status                                                  */
    ...
    __I uint32_t RESERVED3[2];__IO uint32_t GPIOHBCTL; /*!< GPIO High-Performance Bus Control                                     */
    __IO uint32_t RCC2; /*!< Run-Mode Clock Configuration 2                                        */
    __I uint32_t RESERVED4[2];__IO uint32_t MOSCCTL; /*!< Main Oscillator Control                                               */
    __I uint32_t RESERVED5[32];__IO uint32_t RCGC0; /*!< Run Mode Clock Gating Control Register 0                              */
    __IO uint32_t RCGC1; /*!< Run Mode Clock Gating Control Register 1                              */
    __IO uint32_t RCGC2; /*!< Run Mode Clock Gating Control Register 2                              */
    __I uint32_t RESERVED6;__IO uint32_t SCGC0; /*!< Sleep Mode Clock Gating Control Register 0                            */
    ...
    __I uint32_t RESERVED7;__IO uint32_t DCGC0; /*!< Deep Sleep Mode Clock Gating Control Register 0                       */
    ...
    __I uint32_t RESERVED8[6];__IO uint32_t DSLPCLKCFG; /*!< Deep Sleep Clock Configuration                                        */
    __I uint32_t RESERVED9;__IO uint32_t SYSPROP; /*!< System Properties                                                     */
    ...
    __I uint32_t RESERVED10[2];__IO uint32_t PLLFREQ0; /*!< PLL Frequency 0                                                       */
    __IO uint32_t PLLFREQ1; /*!< PLL Frequency 1                                                       */
    __IO uint32_t PLLSTAT; /*!< PLL Status                                                            */
    __I uint32_t RESERVED11[7];__IO uint32_t SLPPWRCFG; /*!< Sleep Power Configuration                                             */
    __IO uint32_t DSLPPWRCFG; /*!< Deep-Sleep Power Configuration                                        */
    __IO uint32_t DC9; /*!< Device Capabilities 9                                                 */
    __I uint32_t RESERVED12[3];__IO uint32_t NVMSTAT; /*!< Non-Volatile Memory Information                                       */
    __I uint32_t RESERVED13[4];__IO uint32_t LDOSPCTL; /*!< LDO Sleep Power Control                                               */
    __I uint32_t RESERVED14;__IO uint32_t LDODPCTL; /*!< LDO Deep-Sleep Power Control                                          */
    __I uint32_t RESERVED15[80];__IO uint32_t PPWD; /*!< Watchdog Timer Peripheral Present                                     */
    ...
    __I uint32_t RESERVED16;__IO uint32_t PPHIB; /*!< Hibernation Peripheral Present                                        */
    ...
    __I uint32_t RESERVED17;__IO uint32_t PPUSB; /*!< Universal Serial Bus Peripheral Present                               */
    __I uint32_t RESERVED18[2];__IO uint32_t PPCAN; /*!< Controller Area Network Peripheral Present                            */
    ...
    __I uint32_t RESERVED19[4];__IO uint32_t PPEEPROM; /*!< EEPROM Peripheral Present                                             */
    __IO uint32_t PPWTIMER; /*!< 32/64-Bit Wide General-Purpose Timer Peripheral Present               */
    __I uint32_t RESERVED20[104];__IO uint32_t SRWD; /*!< Watchdog Timer Software Reset                                         */
    ...
    __I uint32_t RESERVED21;__IO uint32_t SRHIB; /*!< Hibernation Software Reset                                            */
    ...
    __I uint32_t RESERVED22;__IO uint32_t SRUSB; /*!< Universal Serial Bus Software Reset                                   */
    __I uint32_t RESERVED23[2];__IO uint32_t SRCAN; /*!< Controller Area Network Software Reset                                */
    ...
    __I uint32_t RESERVED24[4];__IO uint32_t SREEPROM; /*!< EEPROM Software Reset                                                 */
    __IO uint32_t SRWTIMER; /*!< 32/64-Bit Wide General-Purpose Timer Software Reset                   */
    __I uint32_t RESERVED25[40];__IO uint32_t RCGCWD; /*!< Watchdog Timer Run Mode Clock Gating Control                          */
    ...
    __I uint32_t RESERVED26;__IO uint32_t RCGCHIB; /*!< Hibernation Run Mode Clock Gating Control                             */
    ...
    __I uint32_t RESERVED27;__IO uint32_t RCGCUSB; /*!< Universal Serial Bus Run Mode Clock Gating Control                    */
    ...
    __I uint32_t RESERVED29[4];__IO uint32_t RCGCEEPROM; /*!< EEPROM Run Mode Clock Gating Control                                  */
    ...
    __I uint32_t RESERVED32;__IO uint32_t SCGCUSB; /*!< Universal Serial Bus Sleep Mode Clock Gating Control                  */
    __I uint32_t RESERVED33[2];__IO uint32_t SCGCCAN; /*!< Controller Area Network Sleep Mode Clock Gating Control               */
    ...
    __I uint32_t RESERVED37;__IO uint32_t DCGCUSB; /*!< Universal Serial Bus Deep-Sleep Mode Clock Gating Control             */
    ...
    __IO uint32_t DCGCWTIMER; /*!< 32/64-Bit Wide General-Purpose Timer Deep-Sleep Mode Clock Gating
     Control                                                               */
    __I uint32_t RESERVED40[104];__IO uint32_t PRWD; /*!< Watchdog Timer Peripheral Ready                                       */
    ...
    __I uint32_t RESERVED41;__IO uint32_t PRHIB; /*!< Hibernation Peripheral Ready                                          */
    ...
    __I uint32_t RESERVED42;__IO uint32_t PRUSB; /*!< Universal Serial Bus Peripheral Ready                                 */
    __I uint32_t RESERVED43[2];__IO uint32_t PRCAN; /*!< Controller Area Network Peripheral Ready                              */
    ...
    __I uint32_t RESERVED44[4];__IO uint32_t PREEPROM; /*!< EEPROM Peripheral Ready                                               */
...
{ /*!< UDMA Structure                                                        */
    ...
    __I uint32_t RESERVED0[3];__IO uint32_t ERRCLR; /*!< DMA Bus Error Clear                                                   */
    __I uint32_t RESERVED1[300];__IO uint32_t CHASGN; /*!< DMA Channel Assignment                                                */
    __IO uint32_t CHIS; /*!< DMA Channel Interrupt Status                                          */
    __I uint32_t RESERVED2[2];__IO uint32_t CHMAP0; /*!< DMA Channel Map Select 0                                              */
